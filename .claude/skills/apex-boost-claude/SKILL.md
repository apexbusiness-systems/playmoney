---
name: apex-boost
description: "APEX-BOOST v1.0 | Claude Edition: Omnipotent AI performance amplifier. 20x speed·quality·efficiency·reasoning. Token-ruthless. Research-grounded (SPR·CoT·ToT·ReAct·Constitutional AI·Google Antigravity 2.0). Triggers: /apex-boost · task start · session init · slow output · token waste · drift · loop · hallucination · optimize · amplify · boost · accelerate · performance · enhance · intelligence · efficiency · apex boost · god mode"
license: "Proprietary — APEX Business Systems Ltd. Edmonton, AB, Canada"
version: "1.0.0"
compatibility: "Claude 4.x (native) · computer_use · bash_tool · extended_thinking · all APEX skills"
supersedes: null
tags: [meta-skill, performance, efficiency, reasoning, token-optimization, antigravity]
---
